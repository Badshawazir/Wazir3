...
def login_lagi334():
	try:
		...
		print(f'  {x}[{h}•{x}]{h} [✓] log in succes, silahkan ketik ulang perintah nya 😁{x} ');time.sleep(1)
		exit()
...
def dump_massal():
	...
	try:
		...
		print('[×] Masukkan Angka, Malah Huru ')
		exit()
	if jum<1 or jum>100:
		print('[×] Gagal Dump ID ')
		exit()
...
def setting():
	...
	if hc in ['1','01']:
		...
		method.append('mobile')
	print('')
	pwplus=input(f'{x}•➣ Tambahkan Password Manual ( y/t ) : ')
	if pwplus in ['y','Y']:
		pwpluss.append('ya')
